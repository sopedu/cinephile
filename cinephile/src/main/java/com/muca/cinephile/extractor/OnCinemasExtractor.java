...
import com.muca.cinephile.film.OnCinemasFilm;
import com.rometools.rome.feed.synd.SyndEntry;
import com.rometools.rome.io.FeedException;

public interface OnCinemasExtractor extends FilmExtractor {
	final Logger logger = LogManager.getLogger(OnCinemasExtractor.class);
	...
	default void registerOnCinemas() throws IOException, CantReadEntries {
		...
		try {
			...
			extractDescription = "";
			logger.error("No description found for film called :"
					+ extractTitle);
		}
